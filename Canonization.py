nautyPath = '/Users/jstaple/Desktop/nautyTraces/nauty26r5/dreadnaut'
...
def TableauToLists(SystemString):
    ...
    while SystemString[-1]=='':
        SystemString = SystemString[:-1]
...
try:
    ...
    System = open(sys.argv[1])
    SystemString = System.read()
    print GetUniqueString(CreateNautyString(MakeConstIntoVar(TableauToLists(SystemString))))
